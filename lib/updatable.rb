...
module Updatable
  ...
  # @param promoted_piece [Piece, nil] The piece promoted to (if any)
  # @return nil
  def update_non_castling_notation(player, piece_stats, active_piece, destination, promoted_piece)
    ...
    player.notation[0] = piece_notation(piece_stats, active_piece) # Piece symbol (e.g., 'N' for knight)
  ...
  # @param piece_stats [Hash] Statistics about chess pieces
  # @param promoted_piece [Piece, nil] The piece promoted to
